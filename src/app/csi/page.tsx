      ...
      <section className="section bg-secondary" style={{ marginTop: '4rem' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {/* Solar Metric */}
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-panel-10" style={{ padding: '3rem 2rem', borderRadius: '4px', borderTop: '4px solid var(--accent-gold)' }}>
            ...
            {/* Water Metric */}
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="glass-panel-10" style={{ padding: '3rem 2rem', borderRadius: '4px', borderTop: '4px solid #3b82f6' }}>
            ...
            {/* Efficiency Metric */}
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="glass-panel-10" style={{ padding: '3rem 2rem', borderRadius: '4px', borderTop: '4px solid #10b981' }}>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem', alignItems: 'center' }}>
            <div style={{ height: '700px', borderRadius: '4px', overflow: 'hidden' }}>
              <Image src="/images/portfolio/Dagbreek-school-Fortitude-Property-Group-27-700x840.jpg" alt="Dagbreek School Initiative" fill style={{ objectFit: 'cover' }} />
            </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div className="glass-panel-10" style={{ padding: '1.5rem', borderRadius: '4px', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
